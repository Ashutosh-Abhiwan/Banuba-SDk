...
namespace BNB
{
    public static class BanubaSDKBridge
    {
        ...
        /// <param name="frx_model">Name of FRX model to use, can be empty for default model</param>
        /// <param name="aux_dir">Directory name with AUX, can be empty for default</param>
        /// <param name="is_async">UNUSED will be removed soon</param>
        /// <param name="error">bnb_error**, may be null</param>
        /// <returns>New recognizer instance</returns>
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr bnb_recognizer_init(string resource_folder, string frx_model, string aux_dir, bool is_async, out IntPtr error);
        ...
        /// <summary>Set algorithm for face search</summary>
        /// <param name="recognizer">recognizer instance</param>
        /// <param name="mode">face search mode</param>
        /// <param name="error">bnb_error**, may be NULL</param>
        /// <returns></returns>
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern void bnb_recognizer_set_face_search_mode(IntPtr recognizer, bnb_face_search_mode_t mode, out IntPtr error);
